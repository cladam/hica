...
For a ready-made validated-string type that works across library boundaries, see [`std/trusted`](/docs/standard-library#trust-boundaries-stdtrusted-import-stdtrusted-required) in the standard library.
